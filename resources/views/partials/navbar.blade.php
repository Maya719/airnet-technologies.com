    ...
    <div class="container mx-auto px-4 sm:px-6">
        <div class="flex items-center justify-between py-3 sm:py-4">
            ...
            <a href="/" class="flex items-center gap-2">
                <img src="{{ asset('assets/images/logos/1701175007_1701156435_final-logo.png') }}"
                    alt="Airnet Technologies" class="h-12 sm:h-14 md:h-16 w-auto">
            </a>
                        ...
                        <div
                            ...
                            <div class="bg-white rounded-xl shadow-2xl border border-gray-100 overflow-hidden">
                                ...
                                <a href="{{ url('paiex') }}"
                                    ...
                                    <div class="flex-1">
                                        <div
                                            class="font-semibold text-gray-800 group-hover/item:text-[#008080] transition-colors">
                                            PIE
                                        </div>
                                        <div class="text-xs text-gray-500 whitespace-nowrap">Perception Insight Explorer
                                        </div>
                                    </div>
                                    <i
                                ...
                                <a href="{{ url('Peri') }}"
                                    ...
                                    <div class="flex-1">
                                        <div
                                            class="font-semibold text-gray-800 group-hover/item:text-primary transition-colors">
                                            PERI</div>
                                        <div class="text-xs text-gray-500 whitespace-nowrap">Plan Execute Review &
                                            Improve</div>
                                    </div>
                                    <i
        ...
        <nav id="mobile-menu" class="lg:hidden overflow-hidden max-h-0 transition-all duration-300 ease-in-out">
            <ul class="flex flex-col space-y-1 pb-4">
                <li><a class="block py-3 px-4 text-gray-700 hover:bg-primary/10 hover:text-primary font-medium transition-colors mobile-menu-link"
